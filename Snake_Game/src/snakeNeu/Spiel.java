...
public class Spiel extends JPanel implements ActionListener {
	...
	// Koordinaten des Apfels(negativ, damit am Beginn nicht gezeichnet)
	private int apfel_x_Koordinate = -1;
	private int apfel_y_Koordinate = -1;
	...
	public void apfelChecken() {
		if (schlange_x_Koordinate[0] == apfel_x_Koordinate && schlange_y_Koordinate[0] == apfel_y_Koordinate) {
			länge_Schlange++;
			schlange_x_Koordinate[länge_Schlange] = schlange_x_Koordinate[länge_Schlange - 1];
			schlange_y_Koordinate[länge_Schlange] = schlange_y_Koordinate[länge_Schlange - 1];
			score += 100;
	...
	public void erschaffeApfel() {
		...
		apfel_x_Koordinate = random.nextInt(19) * 20;
		apfel_y_Koordinate = random.nextInt(19) * 20;
		for (int i = 0; i <= länge_Schlange; i++) {
			while (apfel_x_Koordinate == schlange_y_Koordinate[i] && apfel_y_Koordinate == schlange_y_Koordinate[i]) {
				apfel_x_Koordinate = random.nextInt(19) * 20;
				apfel_y_Koordinate = random.nextInt(19) * 20;
			}
		}
	...
	protected void paintComponent(Graphics g) {
		...
		if (alive) {
			...
			g.drawImage(apple, apfel_x_Koordinate, apfel_y_Koordinate, this);
